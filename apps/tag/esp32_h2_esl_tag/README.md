...
BUSY -> pin 4
```
3. Make sure the correct USB port under `Tools -> Port: ...` is selected.

4. Connect the end of the USB-C to USB-C cable that is free to your computer and make sure sure that in the lower right corner of the Arduino IDE window  
...
[PLACEHOLDER for Sammy to write appropriate instructions here.]